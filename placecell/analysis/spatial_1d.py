...
def compute_raw_rate_map_1d(
    ...
    # Narrow to bins with non-zero raw occupancy; valid_mask comes from
    # smoothed occupancy so it can include bins where raw occupancy is 0.
    divide_mask = valid_mask & (occupancy_time > 0)
    rate_map[divide_mask] = event_weights[divide_mask] / occupancy_time[divide_mask]
    return rate_map
